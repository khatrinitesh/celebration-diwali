    ...
    <>
       <input
        ...
        spellCheck={spellCheck}  // Set spellCheck attribute
          ...
          className={`${className} border-tertiarycolor transition-all duration-200 delay-200  border-2 placeholder:text-[rgba(89,46,124,.4)] leading-[38px]  block w-full h-[48px] md:h-[38px] 2xl:h-[48px]  px-[20px]  font-gotham-medium fieldInput text-tertiarycolor relative z-[1] outline-none rounded-[30px] ${variants === "primary" ? 'active' : 'inactive'}`}
        />
